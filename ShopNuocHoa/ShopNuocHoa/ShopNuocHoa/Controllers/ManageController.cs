...
namespace ShopNuocHoa.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        {
            var userId = User.Identity.GetUserId();
            db.Database.ExecuteSqlCommand("Update dbo.AspNetUsers set UserName ='" + model.info.UserName + "',FullName= '"+model.info.FullName+"',Email='"+model.info.Email+"',PhoneNumber='"+model.info.PhoneNumber+"' where Id ='" + userId + "'");
